...
banana_url <- "https://redsky.target.com/redsky_aggregations/v1/web/pdp_client_v1?key=9f36aeafbe60771e321a7cc95a78140772ab3e96&tcin=15013944&is_bot=false&store_id=1137&pricing_store_id=1137"
...
# CSV
output_file <- "raw_price_data/raw_east_target_data.csv"
